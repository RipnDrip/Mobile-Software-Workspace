...
public class JobLeadRecyclerAdapter extends RecyclerView.Adapter<JobLeadRecyclerAdapter.JobLeadHolder> {
    ...
    // This method fills in the values of a holder to show a JobLead as item in the RecyclerView
    // at the given position.
    // The position parameter also indicates the position on the list of jobs list.
    @Override
    public void onBindViewHolder( JobLeadHolder holder, int position ) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DialogFragment editJobFragment =
                        EditJobLeadDialogFragment.newInstance( holder.getAdapterPosition(), company, phone, url, comments );
