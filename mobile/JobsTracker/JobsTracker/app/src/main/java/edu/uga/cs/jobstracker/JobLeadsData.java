        ...
        try {
            ...
            if( cursor.getCount() > 0 ) {
                while( cursor.moveToNext() ) {
                    ...
                    long id = cursor.getLong( cursor.getColumnIndex( JobLeadsDBHelper.JOBLEADS_COLUMN_ID ) );
                    String name = cursor.getString( cursor.getColumnIndex( JobLeadsDBHelper.JOBLEADS_COLUMN_NAME ) );
                    String phone = cursor.getString( cursor.getColumnIndex( JobLeadsDBHelper.JOBLEADS_COLUMN_PHONE ) );
                    String uri = cursor.getString( cursor.getColumnIndex( JobLeadsDBHelper.JOBLEADS_COLUMN_URL ) );
                    String comments = cursor.getString( cursor.getColumnIndex( JobLeadsDBHelper.JOBLEADS_COLUMN_COMMENTS ) );
